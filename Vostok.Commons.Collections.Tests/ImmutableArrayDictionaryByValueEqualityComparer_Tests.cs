...
namespace Vostok.Commons.Collections.Tests
{
    ...
    public class ImmutableArrayDictionaryByValueEqualityComparer_Tests
    {
        ...
        private ImmutableArrayDictionaryByValueEqualityComparer<TKey, TValue> GetComparerInstance<TKey, TValue>() => ImmutableArrayDictionaryByValueEqualityComparer<TKey, TValue>.Instance;
    }
}